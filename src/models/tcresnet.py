...
class Block(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride):
        ...
        self.conv1 = nn.Conv2d(in_planes, planes, kernel_size=(1, 3), stride=stride, padding=(0, 1), bias=False)
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride):
        ...
        self.n2 = nn.BatchNorm2d(planes)
        self.conv2 = nn.Conv2d(planes, planes, kernel_size=(1, 3), stride=stride, padding=(0, 1), bias=False)
...
class ResNet(nn.Module):
    def __init__(self, data_shape, hidden_size, block, num_blocks, target_size):
        ...
        self.conv1 = nn.Conv2d(data_shape[1], hidden_size[0], kernel_size=(1, 3), stride=1, padding=(0, 1), bias=False)
